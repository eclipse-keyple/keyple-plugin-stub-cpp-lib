...
public:
    ...
    public:
         ...
         * unique)
         * @param isContactLess true if the created reader should be
         * contactless, false if not.
        ...
        /**
         * Returns an instance of StubPluginFactory created from the fields set
         * on this builder.
         *
    ...
    private:
         ...
         *
         */
        std::vector<std::shared_ptr<StubReaderConfiguration>>
