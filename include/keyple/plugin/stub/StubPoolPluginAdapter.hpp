 ...
 * @since 2.0.0
 */
class KEYPLEPLUGINSTUB_API StubPoolPluginAdapter : public StubPoolPlugin,
...
public:
    ...
    allocateReader(const std::string& readerGroupReference) override;
...
private:
    ...
    listReadersByGroup(const std::string& aGroupReference);
};
